...
import { X, Send, CheckCircle, RotateCcw, Trash2, AlertCircle, ArrowLeft, MessageSquare } from 'lucide-react';
          ...
          <div className="flex flex-row flex-wrap items-start gap-8">
            ...
            <div className="flex w-full max-w-[1000px] flex-col gap-8">
              ...
              <div className="-mt-3.5 flex flex-wrap items-center gap-2.5">
                ...
                {/* 4. Discussions */}
                <button
                  onClick={() => navigate(`/task/${task.id}/threads`)}
                  className="btn flex items-center gap-2 border border-[var(--border-color)] bg-[var(--bg-secondary)] px-4 py-2 text-[0.85rem] text-[var(--text-primary)]"
                >
